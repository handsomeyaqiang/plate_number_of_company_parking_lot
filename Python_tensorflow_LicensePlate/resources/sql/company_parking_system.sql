...
CREATE TABLE `record` (
  ...
  `vehicletype` varchar(11) DEFAULT NULL COMMENT '车辆类型 0：内部车   1:外部车',
...
CREATE TABLE `staff` (
  ...
  `gender` varchar(11) DEFAULT '0' COMMENT '员工性别 male:0  female:1',
...
-- Records of staff
-- ----------------------------
INSERT INTO `staff` VALUES ('0001', '2', 'tom', '1539928163', '男', '1539928163');
INSERT INTO `staff` VALUES ('0002', '1', 'Jike', '1565626854', '男', '销售部');
INSERT INTO `staff` VALUES ('0003', '0', 'rose', '1535456456', '男', '开发部');
INSERT INTO `staff` VALUES ('0004', '2', 'wang', '1545454242', '女', '研发部');
INSERT INTO `staff` VALUES ('0005', '1', 'mike', '1535445874', '女', '销售部');
INSERT INTO `staff` VALUES ('0006', '2', 'rose', '1889651452', '女', '开发部');
INSERT INTO `staff` VALUES ('0007', '0', '张三', '1582653542', '男', '销售部');
INSERT INTO `staff` VALUES ('0008', '1', '李四', '1468252547', '男', '策划部');
INSERT INTO `staff` VALUES ('0009', '2', '王五', '1548485354', '男', '策划部');
INSERT INTO `staff` VALUES ('0010', '2', '呵呵', '18852245985', '女', '策划部');
INSERT INTO `staff` VALUES ('0011', '0', '周华', '18852484141', '女', '策划部');
INSERT INTO `staff` VALUES ('0012', '2', '王兰', '18852241545', '女', '策划部');
INSERT INTO `staff` VALUES ('0013', '2', '王昌龄', '18854512120', '男', '开发部');
INSERT INTO `staff` VALUES ('0014', '0', '李白', '18852245751', '女', '开发部');
INSERT INTO `staff` VALUES ('0016', '2', '元稹', '18852245582', '男', '开发部');
