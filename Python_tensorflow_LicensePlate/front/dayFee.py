...
class Ui_dayFee(object):
    def setupUi(self, dayFee):
        ...
        self.endtimeedit = QtWidgets.QTimeEdit(self.gridLayoutWidget)
        self.endtimeedit.setObjectName("endtimeedit")
        self.gridLayout.addWidget(self.endtimeedit, 3, 1, 1, 1)
        ...
        self.starttimeedit = QtWidgets.QTimeEdit(self.gridLayoutWidget)
        self.starttimeedit.setObjectName("starttimeedit")
        self.gridLayout.addWidget(self.starttimeedit, 2, 1, 1, 1)
