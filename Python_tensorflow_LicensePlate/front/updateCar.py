...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.num_lineEdit, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Chejia_lineEdit, 5, 2, 1, 1)
        self.car_lineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.car_lineEdit.setObjectName("car_lineEdit")
        self.gridLayout.addWidget(self.car_lineEdit, 0, 2, 1, 1)
