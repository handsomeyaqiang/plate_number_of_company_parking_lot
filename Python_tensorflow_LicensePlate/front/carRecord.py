...
class Ui_carRecord(object):
    def setupUi(self, carRecord):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(50, 150, 481, 181))
    ...
    def retranslateUi(self, carRecord):
        ...
        self.comboBox.setItemText(2, _translate("carRecord", "进入时间(XX-YY-ZZ  AA:BB:CC)"))
        self.comboBox.setItemText(3, _translate("carRecord", "离开时间(XX-YY-ZZ  AA:BB:CC)"))
